    ...
    <ThemeProvider theme={theme}>
      <Container maxWidth="xl">
        <Paper elevation={3} sx={{ p: 10 }} borderRadius="48px">
          ...
          <Section title={<FormattedMessage id="ColivriDigitalTwin" />}>
          ...
          <Box sx={{ my: 4, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src="/images/colivri.jpg" alt="colivri digital twin" className="features-img3" />
              <img src="/images/colivri2.jpg" alt="colivri digital twin" className="features-img3" />
          </Box>

          {/* Sección: What is a Digital Twin? */}
          <Section title={<FormattedMessage id="DigitalTwin" />} subtitle={<FormattedMessage id="DigitalTwinDef.p1" />} borderTop={true}>
            <Box sx={{ my: 4, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img src="/images/Digital-Twins.jpg" alt="colivri digital twin" className="features-img2" />
            </Box>
            <Box sx={{ my: 2 }} />
